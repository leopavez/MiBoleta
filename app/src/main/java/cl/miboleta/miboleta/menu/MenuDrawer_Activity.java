...
import cl.miboleta.miboleta.activities.loginActivity;
...
public class MenuDrawer_Activity extends AppCompatActivity
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_logout) {
            Intent intent = new Intent(MenuDrawer_Activity.this,loginActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()){
            case R.id.nav_boleta:
                fragment = new Boleta_Fragment();
